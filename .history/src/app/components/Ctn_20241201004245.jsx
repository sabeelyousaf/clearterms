    ...
    <div>
       <div className="bg-white shadow rounded-lg p-6 mb-8 w-100">
              <div className="flex flex-row items-center flex-wrap">
               ...
               <img className="mb-5  md:ms-auto lg:ms-auto d-block m-auto   me-3" src="https://upload.wikimedia.org/wikipedia/commons/thumb/e/e1/Google_Chrome_icon_%28February_2022%29.svg/768px-Google_Chrome_icon_%28February_2022%29.svg.png"  width="60" alt="" />
               </div>
