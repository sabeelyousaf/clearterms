...
const ContactComponent = () => {
  ...
  return (
    ...
    >
      <div className="max-w-screen-xl mx-auto md:px-0 px-3 mb-3">
        ...
        <div className="flex flex-wrap ">
          ...
          <div className="w-full md:w-1/2 space-y-6 lg:pe-5 md:pe-5">
            ...
            <img src="https://img.freepik.com/free-vector/vector-blue-arrow-isolated-white_1284-41891.jpg" className="w-1/2 mob-hide ms-auto d-block" alt="" />
          </div>
