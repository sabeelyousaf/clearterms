    ...
    <div className="flex flex-col items-center">
      ...
      <p className="text-red-500 mt-2">Translating...</p>
            ...
            <div className="flex justify-center space-x-4 mb-4">
              ...
              <button
                className="bg-blue-500 text-white px-4 py-2 rounded-lg hover:bg-blue-600 focus:outline-none flex items-center  className={`p-2 border rounded-lg focus:outline-none ${
